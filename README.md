...
### ✨ 核心功能
- 🚀 **全面支持多工具**：除了 Claude Code，新增支持 Cursor, VS Code, Windsurf, Trae, Qoder, Antigravity 等 20+ 种 AI 编程工具
- 🛡️ **安全防护增强**：全新的安全扫描引擎，覆盖 8 大风险类别
- 🌐 **一键翻译**：集成 Google Translate，支持技能描述一键中英互译
- 🎨 **全新 UI**：macOS 风格的流体设计，操作更丝滑
